 ...
 * memory efficient that the original file. This file is used 
...
template <typename T>
  ...
  public:
    ...
    ///
    /// \ref NetworkSimplexSimple provides five different pivot rule
  ...
  private:
	  ...
	  inline int sequence(int k) const {
		  ...
		  int subsequence_length2 = subsequence_length- small;
		  int subsequence_num = (k / subsequence_length2) + num_big_subseqiences * small;
    ...
    public:
      ...
      // Constructor
      FirstEligiblePivotRule(NetworkSimplexSimple &ns) :
    ...
    public:
      ...
      // Constructor
      BestEligiblePivotRule(NetworkSimplexSimple &ns) :
        _source(ns._source), _target(ns._target),
        _cost(ns._cost), _state(ns._state), _pi(ns._pi),
        _in_arc(ns.in_arc), _search_arc_num(ns._search_arc_num)
      {}
    ...
    public:
      ...
      /// Constructor
      CandidateListPivotRule(NetworkSimplexSimple &ns) :
        _source(ns._source), _target(ns._target),
        _cost(ns._cost), _state(ns._state), _pi(ns._pi),
        _in_arc(ns.in_arc), _search_arc_num(ns._search_arc_num),
        _next_arc(0)
    ...
    public:
      ...
      // Constructor
      AlteringListPivotRule(NetworkSimplexSimple &ns) :
        _source(ns._source), _target(ns._target),
        _cost(ns._cost), _state(ns._state), _pi(ns._pi),
        _in_arc(ns.in_arc), _search_arc_num(ns._search_arc_num),
  ...
  public:
    ...
    NetworkSimplexSimple(const GR& graph, bool arc_mixing = false) :
          ...
          std::numeric_limits<Value>::infinity() : MAX)
    {
      ...
      LEMON_ASSERT(std::numeric_limits<Value>::is_signed,
        "The flow type of NetworkSimplexSimple must be signed");
      LEMON_ASSERT(std::numeric_limits<Cost>::is_signed,
        "The cost type of NetworkSimplexSimple must be signed");
